    ...
    class DataFetcher
    {
        ...
        public FootballMatch GetMatchByHtml(string htmlCode, string matchId)
        {
            ...
            if (nodesGoals.Count == 2)
            {
                ...
                home.Goals = int.TryParse(homeGoals, out int k) ? Convert.ToInt32(homeGoals) : null;
                away.Goals = int.TryParse(awayGoals, out k) ? Convert.ToInt32(awayGoals) : null;
            }
